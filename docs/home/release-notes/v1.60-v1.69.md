...
- After the update, after about 5 minutes you have to manually restart kubernetes pods `core` and `applications` because of a bug related to the JDBC connector.
