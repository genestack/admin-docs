...
!!! tip ""
    Helm chart version 1.61.x

### Helm configuration changes

- Mailcatcher has been replaced by another tool.
If you don't use it or don't make any changes to the default configuration, then you don't need to do anything.
